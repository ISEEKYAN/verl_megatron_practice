...
## !!!!!!!important!!!!!!
## set several environment variables on a runtime_env.yaml and add it to the command by `--runtime-env=runtime_env.yaml`
## to add
# env_vars:
#   CUDA_DEVICE_MAX_CONNECTIONS: "1"
#   NCCL_NVLS_ENABLE: "0"

# adopt the optimizations from https://github.com/volcengine/verl/pull/2678
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
[ -f "${SCRIPT_DIR}/env.sh" ] && source "${SCRIPT_DIR}/env.sh"

project_name='DAPO'
exp_name='30B-megatron-4node_tp1ep8_deepep_full_opt2.2'
...
actor_ppo_max_token_len=$(((max_prompt_length + max_response_length) * 15 / 10))
